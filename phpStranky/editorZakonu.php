...
<title>Unit Roleplay - Editor zákonů</title>
</head>
<body>
  ...
  <!--KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL-->
	...
	if(isset($_SESSION['idUzivatele'])){
		...
		echo '<div class="container" id="textUvod">
			    <div class="row">
			      <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">Editor zákonů</h1>
			    </div>
			    <br>
			    <form class="editorPravidel" action="../skripty/upravitZakony.php" method="post">';
			        $sql = "SELECT * FROM zakony";
			    		$vys= mysqli_query($pripojeni,$sql);
