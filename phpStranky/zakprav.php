...
<title>Unit Roleplay - Základní pravidla</title>
</head>
<body>
  ...
  <div class="container" id="pravidlaUprava">
    <div class="row" style="text-align:center;">
      <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;font-family: 'Rajdhani', sans-serif !important;">Základní pravidla</h1>
    </div>
    <br>
		<div class="row" style="text-align:center;">
