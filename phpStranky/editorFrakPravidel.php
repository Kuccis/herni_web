...
<title>Unit Roleplay - Editor frakčních pravidel</title>
</head>
<body>
	...
	if(isset($_SESSION['idUzivatele'])){
		if($_SESSION['adminStav'] == 4 || $_SESSION['adminStav'] == 5){
				echo	'<div class="container" id="textUvod">
					    <div class="row">
					      <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">Editor frakčních pravidel</h1>
					    </div>
					    <br>
					    <form class="editorPravidel" action="../skripty/upravitFrakPravidla.php" method="post">';
