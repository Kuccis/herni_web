...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../Bootstrap/stylyAteam.css">
...
<body>
  ...
  <!--KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL-->
	...
	<div class="container" id="textAteam">
		<div class="row">
      <h1 class="uvodVety" style="font-size: 70px;font-weight:bold;">A-team</h1>
    </div>
    <div class="row">
      <h2 class="uvodVety" style="font-style: italic;">Roleplay is yours…</h2>
		...
		<br>
		<?php
		$sqli = "SELECT * FROM uzivatele WHERE admin = 5 ORDER BY id"; 	//limit - max int, dotazuju se na vypis vseho na urcitem id, ktere si beru z posledniho znaku v URL, kde si ho nastavuju podle id, když beru všechny řádky z datbaze
		$vysi = mysqli_query($pripojeni,$sqli);

		  echo '<div class="row">';

			while($row = mysqli_fetch_assoc($vysi)){
			echo		 '
									<div class="col-12 col-sm-6 col-md-4 col-lg-3" style="margin-left:auto;margin-right:auto;">
						      <div class="our-team">
						        <div class="picture">';
										if($row['profilovka'] == 0){
										 $filename="../profilovka/profile".$row['id']."*";
										 $fileinfo=glob($filename);
										 $fileext=explode(".",$fileinfo[0]);
							        echo '<img src="../profilovka/profile'.$row['id'].'.'.$fileext[3].'" class="img-fluid" style="width:130px;height:130px;" alt="Profilová fotografie">';
										}
										else{
												 echo '<img src="../profilovka/default.jpg"  class="img-fluid" style="width:130px;height:130px;" alt="Profilová fotografie">';
										}
						  echo  '</div>
						        <div class="team-content">
						          <h2 class="name">'.$row['jmeno'].'</h2>
						          <h4 class="title" style="color:#ff6262;font-size: 20px;font-weight:bolder;">Majitel</h4>
						        </div>
						        <ul class="social">
						        </ul>
						  		</div>
			...
			<?php
			$sqli = "SELECT * FROM uzivatele WHERE admin = 4"; 	//limit - max int, dotazuju se na vypis vseho na urcitem id, ktere si beru z posledniho znaku v URL, kde si ho nastavuju podle id, když beru všechny řádky z datbaze
			$vysi = mysqli_query($pripojeni,$sqli);
			  ...
			  echo '<div class="row">';
				...
				echo		 '
							  ...
							  echo  '</div>
							        <div class="team-content">
							          <h2 class="name">'.$row['jmeno'].'</h2>
							          <h4 class="title" style="color:#3498db;font-size: 20px;font-weight:bolder;">Administrátor</h4>
							        </div>
							        <ul class="social">
							        </ul>
							  		</div>
			...
			<?php
			$sqli = "SELECT * FROM uzivatele WHERE admin = 3"; 	//limit - max int, dotazuju se na vypis vseho na urcitem id, ktere si beru z posledniho znaku v URL, kde si ho nastavuju podle id, když beru všechny řádky z datbaze
			$vysi = mysqli_query($pripojeni,$sqli);
				...
				echo		 '
								...
								echo  '</div>
											<div class="team-content">
												<h2 class="name">'.$row['jmeno'].'</h2>
												<h4 class="title" style="color:#e67e22;font-size: 20px;font-weight:bolder;">Developer</h4>
											</div>
											<ul class="social">
											</ul>
										</div>
			...
			<?php
			$sqli = "SELECT * FROM uzivatele WHERE admin = 2"; 	//limit - max int, dotazuju se na vypis vseho na urcitem id, ktere si beru z posledniho znaku v URL, kde si ho nastavuju podle id, když beru všechny řádky z datbaze
			$vysi = mysqli_query($pripojeni,$sqli);
				...
				echo		 '
								...
								echo  '</div>
											<div class="team-content">
												<h2 class="name">'.$row['jmeno'].'</h2>
												<h4 class="title" style="color:#b203b8;font-size: 20px;font-weight:bolder;">Grafik</h4>
											</div>
											<ul class="social">
											</ul>
										</div>
			...
			<?php
			$sqli = "SELECT * FROM uzivatele WHERE admin = 1 ORDER BY id DESC"; 	//limit - max int, dotazuju se na vypis vseho na urcitem id, ktere si beru z posledniho znaku v URL, kde si ho nastavuju podle id, když beru všechny řádky z datbaze
			$vysi = mysqli_query($pripojeni,$sqli);
				...
				echo		 '
								...
								echo  '</div>
											<div class="team-content">
												<h2 class="name">'.$row['jmeno'].'</h2>
												<h4 class="title" style="color:#2ecc71;font-size: 20px;font-weight:bolder;">Whitelist tester</h4>
											</div>
											<ul class="social">
											</ul>
										</div>
