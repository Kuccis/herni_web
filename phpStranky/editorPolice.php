...
<title>Unit Roleplay - Editor Police Department</title>
</head>
<body>
  ...
  <!--KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL-->
	...
	if(isset($_SESSION['idUzivatele'])){
		...
		echo '<div class="container" id="textUvod">
		    <div class="row">
		      <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">Editor pravidel Police Department</h1>
		    </div>
		    <br>
		    <form class="editorPravidel" action="../skripty/upravitPolice.php" method="post">';
