...
<body style="font-family: 'Rajdhani', sans-serif !important;">
  ...
  <div class="container" id="textUvod" style="text-align: left;">
    <div class="row">
      <h1 class="uvodVety" style="font-size: 70px;font-weight:bold;text-align:center;">Výpis žádostí o unban</h1>
    </div>
    <div class="row">
            										...
            										<div class="ibox-content forum-container">
            												...
            												<div class="forum-title">
            														<div class="pull-right forum-desc">
            																<small>Počet žádostí o unban: '.$pocetZivotopisu.'</small>
            														</div>
            														<h3>Výpis žádostí o unban</h3>
            												</div>';
            												if($pocetZivotopisu > 0){
                                      while($row = mysqli_fetch_assoc($vys)){
                                        $id = $row['idUziv'];
    																		$sqla = "SELECT *  FROM `uzivatele` WHERE `id` = '$id';"; 	//limit - max int
                                      ...
                                      $datum = strtotime($row['datumPridani']);
            							                    ...
            							                    <div class="row">
            							                        <div class="col-md-9">
            							                            ...
            							                            <div class="forum-sub-title">Autor: '.$rowa['jmeno'].'</div>
            							                        </div>
