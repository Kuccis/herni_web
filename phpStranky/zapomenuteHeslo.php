...
<body style="font-family: 'Rajdhani', sans-serif !important;">
  ...
  <!--KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL KONEC MODAL-->
	<?php
		...
		if(strpos($celaURL,"resetnevyplnenepole=email") == true){
			echo	'<div class="alert alert-warning alert-dismissible fade show" role="alert" id="errorMess">
								<strong>Pozor!</strong> Nevyplnil/a jste e-mail!
		...
		echo '<div class="container" id="textUvod">
						<div class="row">
							<h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">Zapomenuté heslo? Není problém!</h1>
						</div>
						<form class="formularZadost" action="../skripty/zapomenuteHesloSkript.php" method="post">
									<label style="color:white;" for="email">E-mail</label>
									<input type="text" class="form-control" id="email" placeholder="Zadejte váš e-mail, kam Vám zašlepe formulář pro obnovení hesla!" name="email">
									<br>
