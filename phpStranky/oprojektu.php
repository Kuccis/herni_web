...
<body>
  ...
  <div class="container" id="textUvod">
    <div class="row">
      <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">O projektu Unit Roleplay</h1>
    </div>
		<div class="row">
    ...
    <div class="row">
			...
			<br>
			<p id="uvodTexto">
        Projekt UnitRP je herní server, který vznikl na základě komunity platformy FiveM Grand Theft Auto V (GTA 5) herního modu roleplaye.
        Je tvořen pro lidi, kteří hledají zázemí seriozního roleplaye, který zde chceme tvořit! Naším cílem je hráčům poskytnout skvělou komunitu a prostředí pro jejich roleplay.
        Projekt je tvořen zkušeným týmem z komunity za doprovodu skvělých developerů!<br><br>
        Náš tým je tvořen z komunity serveru, kde seriozní roleplay upadl a byl využit spíše pro kontent, než kvalitu.
        Jsme hráči stejně tak, jako vy, kteří se inspirovali Vámi! Chceme dbát na vaší spokojenosti a pomoc Vám rozšířit Váš herní příběh! Jsme jeden tým, který si jde za jedním společným cílem.
        Vznikli jsme, abychom jako hráči dali něco Vám – hráčům, protože „Roleplay is yours..“<br><br>
        Hlavním „majitelem“ je Henry , který se rozhodl vytvořit projekt po nesprávném „fair-play“ jednání vůči komunitě. Na základě toho vznikla myšlenka o projektu, který by jednal férově
        vůči lidem, a seskupili hráče se stejnými ambicemi.<br><br>
        Projekt byl vytvořen týmem zkušených roleplay hráčů pro touhu vybudovat přátelskou komunitu a seriozní roleplay.
        Chceme se s Vámi podělit o zpracované prostředí fiktivního města Los Santos a vidět záři světel Vašich skvělých, unikátních a jedinečných příběhů!
				<br><br>
				MY JSME TU PRO VÁS!
			</p>
		</div>
