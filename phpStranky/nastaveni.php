...
<body>
		                ...
		                <div class="form-group">
		                  ...
		                  <label class="form-control-placeholder">Heslo</label>
										...
										<div class="create-new-fau text-center pt-3">
											<a href="#" class="text-primary-fau">Zapomenuté heslo</a>
		                </div>
  ...
  <div class="container" id="textUvod">
    <div class="row">
      <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">Nastavení účtu</h1>
    </div>
    <div class="row">
      <h2 class="uvodVety" style="font-style: italic;">Zde si můžete změnit váš účet!</h2>
    </div>
    <br>
    <div class="row">
			<div id="vybratFoto">
				<?php
					...
					if(isset($_SESSION['idUzivatele'])){
						...
						echo '<p id="upozorneniFoto"><img src="../profilovka/profile'.$sessionid.'.'.$fileext[3].'" id="profilFotoNastaveni" width="200" height="200" alt="Profilová fotka">
						...
						echo '<h4 id = "jmenoUFoto"><strong>'.$_SESSION['jmenoUzivatele'].'</strong></h4>';
						echo '<p id="upozorneniFoto"><img src="../profilovka/default.jpg" id="profilFotoNastaveni" width="200" height="200" alt="Profilová fotka">
								Profilová fotka musí být menší než 1mb. Podporovanými formáty jsou <strong>jpg, jpeg a png</strong>. Nahrané fotky nesmějí obsahovat rasový podtext,
								případně xenofobní nebo urážlivé obrázky. Jakkoliv závádné fotky budou bez upozornění mazány.</p>';
						}
					}
					...
					if($_SESSION['statusUzivatele'] == 1)
					{
						echo '<form action="../skripty/uploadProfilovky.php" method="post" enctype="multipart/form-data" id="vybratFot">
										<input type="file" name="foto">
									<button type = "submit" name="submit">Změnit profilovou fotku</button>
									<input type="hidden" name="idUzivatele" value="'.$_SESSION['idUzivatele'].'">
										</form>';
					}
					else{
						echo '<form action="../skripty/smazaniProfilovky.php" method="post" id="smazatFoto">
										<button type = "submit" name="submitSmazat" style="margin-top: 20px;">Smazat profilovou fotku</button>
										<input type="hidden" name="idUzivatele" value="'.$_SESSION['idUzivatele'].'">
									</form>';
					}
				}
