    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">VIP small pack</h5>
            <h6 class="card-price text-center">€10<span class="period"></span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>25 000 que bodů</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>12 500$</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Změna telefonního čísla</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>VIP small discord role</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>změna SPZ na libovolných vozích</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Možnost účásti na určitých poradách</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Věrnostní odměna za 3 měsíce v řade</li>
            </ul>
            <a href="https://paypal.me/unitrpeu/10" target="_blank" class="btn btn-block btn-primary text-uppercase" style="background-color:#83e1e6;color:black;">Zakoupit small pack</a>
          </div>
        </div>
      </div>
      <!-- medium -->
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">VIP medium pack</h5>
            <h6 class="card-price text-center">€20<span class="period"></span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span>50 000 que bodů</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>25 000$</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Změna telefonního čísla</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Změna SPZ na libovolných vozích 2x</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Věrnostní odměna za 3 měsíce v řade</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>VIP medium discord role</li>
              <li class="text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Možnost účásti na určitých poradách</li>
            </ul>
            <a href="https://paypal.me/unitrpeu/20" target="_blank" class="btn btn-block btn-primary text-uppercase" style="background-color:#54dce3;color:black;">Zakoupit medium pack</a>
          </div>
        </div>
      </div>
      <!-- large -->
      <div class="col-lg-4">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-muted text-uppercase text-center">VIP large pack</h5>
            <h6 class="card-price text-center">€30<span class="period"></span></h6>
            <hr>
            <ul class="fa-ul">
              <li><span class="fa-li"><i class="fas fa-check"></i></span><strong>100 000 que bodů</strong></li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>60 000$</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Změna telefonního čísla</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Změna SPZ na libovolných vozích 3x</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Věrnostní odměna za 3 měsíce v řade</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>VIP large discord role</li>
              <li><span class="fa-li"><i class="fas fa-check"></i></span>Možnost účásti na určitých poradách</li>
            </ul>
            <a href="https://paypal.me/unitrpeu/30" target="_blank" class="btn btn-block btn-primary text-uppercase" style="background-color:#0dd6e0;color:black;">Zakoupit large pack</a>
          </div>
        </div>
      </div>
    </div>
