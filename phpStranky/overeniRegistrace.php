...
<body>
  ...
  <?php
      ...
      echo  '<div class="container" id="textUvod">
            <div class="row">
              <h1 class="uvodVety" style="font-size: 70px;font-weight: bold;">Dokončete registraci!</h1>
            </div>
            <div class="row">
              <form action="../skripty/overeniRegistraceSkript.php" method="post" style="margin-left:auto;margin-right:auto;">
                <input type="hidden" name="selektor" value="'.$selektor.'">
        			  <input type="hidden" name="validator" value="'.$validator.'">
                <button type="submit" name="potvrzeniRegistrace" class="btn btn-light btn-lg" style="padding:15px;font-weight:bold;">Klikni zde pro potvrzení registrace!</button>
              </form>
          </div>
          </div>';
      }
